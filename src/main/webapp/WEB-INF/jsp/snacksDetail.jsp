...
<head>
<base href="<%=request.getContextPath()%>/home/">
...
<script type="text/javascript">
  function toAddShopCar(_fdId){
	  var _data="id="+_fdId+"&count=" +$("#text_box").val()+"&op=add";
			...
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="../${food.bigPicUrl[0] }"><img
							src="../${food.bigPicUrl[0] }" alt="细节展示放大镜特效"
							rel="../${food.bigPicUrl[0] }" class="jqzoom" /></a>
					</div>
					<ul class="tb-thumb" id="thumblist">
						<c:forEach items="${food.bigPicUrl }" var="bigUrl"></c:forEach>
						<li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a href="#"><img src="../${bigUrl }" mid="../${bigUrl }"
									big="../${bigUrl }"></a>
							</div>
						</li>
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						<li class="price iteminfo_price">
							<dt>促销价</dt>
							<dd>
								<em>¥</em><b class="sys_item_price">${food.promPrice }</b>
							</dd>
						</li>
						<li class="price iteminfo_mktprice">
							<dt>原价</dt>
							<dd>
								<em>¥</em><b class="sys_item_mktprice">${food.fdPrice }</b>
							</dd>
						</li>
						<div class="clear"></div>
					</div>
					...
					<ul class="tm-ind-panel">
						...
						<li class="tm-ind-item tm-ind-sumCount canClick">
							<div class="tm-indcon">
								<span class="tm-label">累计销量</span><span class="tm-count">${food.salesCount }</span>
							</div>
						</li>
										...
										<div class="theme-signin-left">
											...
											<div class="theme-options">
												...
												<ul>
													...
													<c:forTokens items="${food.fdTaste }" delims=" "
														var="taste" varStatus="status">
														<c:choose>
											...
											<div class="theme-options">
												...
												<ul>
													<c:if test="${!empty food.fdPackae }">
														<c:forTokens items="${food.fdPackae}" delims=" "
															var="_package" varStatua="status"}>
															<c:choose>
																<c:when test="${status.index==0 }">
																	<li class="sku-line selected">
																</c:when>
											...
											<div class="theme-options">
												...
												<dd>
													<input id="min" class="am-btn am-btn-default" name=""
														...
														class="tb-hidden">库存<span class="stock">${food.fdInventory }</span>件
													</span>
												</dd>
					...
					<div class="shopPromotion gold">
						<div class="hot">
							...
							<div class="gold-list">
								<p>${food.promList[0].prmName }<i class="am-icon-sort-down"></i></span>
								</p>
							</div>
						</div>
						<div class="clear"></div>
				...
				<div class="pay">
					...
					<li>
						<div class="clearfix tb-btn tb-btn-basket theme-login">
							<a id="LikBasket" title="加入购物车" href="javascript:void(0)" onclick="toAddShopCar(${food.fdId})"><i></i>加入购物车</a>
						</div>
					</li>
				</div>
						...
						<div class="am-tab-panel am-fade am-in am-active">
							...
							<div class="details">
								...
								<div class="twlistNews">
									<c:forEach items="${food.detailPicUrl }" var="detailPic">
										<img src="../${detailPic }" />
									</c:forEach>
								</div>
							</div>
